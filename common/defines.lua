...
country = {
	...
	GOLD_TO_CASH_RATE = 22, -- Amount of money generated per gold unit
	GOLD_TO_WORKER_PAY_RATE = 0.86, -- Multiplier for how much money gold pays to pops
